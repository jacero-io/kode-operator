...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPFilterRouter) DeepCopyInto(out *HTTPFilterRouter) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPFilterRouter.
func (in *HTTPFilterRouter) DeepCopy() *HTTPFilterRouter {
	if in == nil {
		return nil
	}
	out := new(HTTPFilterRouter)
	in.DeepCopyInto(out)
	return out
}
