...
// EntryPointSharedSpec defines the desired state of EntryPoint
type EntryPointSharedSpec struct {
...
type GatewaySpec struct {
	...
	// +kubebuilder:validation:Optional
	PatchPolicy *PatchPolicy `json:"patchPolicy,omitempty" yaml:"patchPolicy,omitempty"`
}
...
// EntryPointSharedStatus defines the observed state for Container
type EntryPointSharedStatus struct {
