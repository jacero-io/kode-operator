...
// ContainerSharedSpec defines the desired state of KodeContainer
type ContainerSharedSpec struct {
...
// ContainerSharedStatus defines the observed state for Container
type ContainerSharedStatus struct {
