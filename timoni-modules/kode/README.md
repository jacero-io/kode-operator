...
A [timoni.sh](http://timoni.sh) module for deploying kode to Kubernetes clusters.
...
```shell
timoni -n default apply kode oci://<container-registry-url>
```
