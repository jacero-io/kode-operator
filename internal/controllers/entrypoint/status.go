...
func (r EntryPointReconciler) updatePhaseCreating(ctx context.Context, entryPoint *kodev1alpha2.EntryPoint) error {
	now := metav1.NewTime(time.Now())
...
func (r EntryPointReconciler) updatePhaseCreated(ctx context.Context, entryPoint *kodev1alpha2.EntryPoint) error {
	now := metav1.NewTime(time.Now())
...
func (r EntryPointReconciler) updatePhasePending(ctx context.Context, entryPoint *kodev1alpha2.EntryPoint) error {
	now := metav1.NewTime(time.Now())
